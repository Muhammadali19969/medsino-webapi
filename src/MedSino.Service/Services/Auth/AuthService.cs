...
#pragma warning disable
    ...
    {
        var result = await _userRepository.GetByPhoneAsync(registerDto.PhoneNumber);
        if (result is not null) throw new UserAlreadyExistsException(registerDto.PhoneNumber);
